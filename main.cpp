...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setOrganizationName("Heidi Martinez");
    QCoreApplication::setOrganizationDomain("Heidi Martinez");
    QCoreApplication::setApplicationName("Jennic Daemon");
